...
const stationColumns = useMemo(
  ...
  { key: 'periodStart', label: '적용시작', minWidth: '130px', mobileMinWidth: '130px' },
  { key: 'periodEnd', label: '적용종료', minWidth: '130px', mobileMinWidth: '130px' }
]

  const measurementColumns = [
    { key: 'datetime', label: '측정일시', minWidth: '130px', mobileMinWidth: '130px' },
    { key: 'h', label: '수위(h)' },
    { key: 'q', label: '유량(Q)' },
